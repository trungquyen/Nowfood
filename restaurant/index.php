...
<body">
    ...
    <div class="container-fluid">
        <div class="main row">
            ...
            <form id="formSign" class="form-center col-sm-5" action="../controller/signinRestaurant.php" method="POST">
                <div class="row mb-2">
                    <label for="inputGmail" class="col-sm-2 col-form-label">Tài khoản</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputGmail" name="gmail" placeholder="Nhập gmail" required>
                    </div>
                </div>
                <div class="row mb-2">
