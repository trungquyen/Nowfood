...
<body>
    <!-- Table -->
    <div class="head">
        <a href="./order.php">Các đơn hàng đã được đặt</a>
    </div>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($result2, MYSQLI_NUM)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#"><button type="button" class="btn btn-danger btn-sm m-0 py-1 px-2">Xem chi tiết</button></a>
                        </td>
                        </form>
                    </tr>
                    ';
    ...
    <a href="./restaurant.php" class="next-page">
        <button type="button" style="height: 50px; margin-right:20px; font-size: 18px" class="btn btn-light">Quản lý các nhà hàng<i class="fas fa-arrow-circle-right"></i></button>
    </a>
